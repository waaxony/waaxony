...
This model card focuses on the model associated with the SD-XL 0.9-base 3.7B parameters model, available [here](https://github.com/Stability-AI/generative-models/). 
